export PJDIR := /home/user/Desktop/pjsip-jni
...
export APP_CFLAGS := -DPJ_AUTOCONF=1\
	-I/home/user/Desktop/usr/local/include/ -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1\
	$(PJ_VIDEO_CFLAGS) \
...
export APP_LDFLAGS := -L$(PJDIR)/pjlib/lib\
	...
	$(PJ_VIDEO_LDFLAGS) \
	-L/home/user/Desktop/usr/local/lib/
...
export APP_LDLIBS := $(PJSUA_LIB_LDLIB) \
	...
	$(APP_THIRD_PARTY_EXT)\
	$(PJLIB_LDLIB) \
	-lcrypto -ldl -lz -luuid -lm -lrt -lpthread  -lasound  
...
export PJ_INSTALL_CFLAGS := -I$(PJ_INSTALL_INC_DIR) -DPJ_AUTOCONF=1	-I/home/user/Desktop/usr/local/include/ -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1
